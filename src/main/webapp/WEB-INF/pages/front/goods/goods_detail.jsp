    ...
    <script>
        ...
        $(function () {
            ...
            $("#joinCar").click(function () {
                ...
                $.post("<%=basePath%>pages/front/member/addShopCar", {
                    goodsId: goodsId,
                    storeId: storeId,
                    account: account
                }, function (data) {
...
<div class="row detail_con">
    <div class="lf lfpic">
        <div class="preview">
            <div id="vertical" class="bigImg">
                <img src="<%=basePath%>/resources/upload/goodsPic/${goods.pic}" width="auto" height="auto" alt=""
                     id="midimg"/>
    ...
    <div class="lf rfword">
        ...
        <div class="clr tg_explain" id="buy">
            <button style="cursor:pointer" class="btnClass joinCar" id="joinCar"><img
                    src="<%=basePath%>/resources/images/icon_08.png"> 加入购物车
            </button>
        </div>
    </div>
    <div class="clr"></div>
                            ...
                            <div class="tab-con">
                                <div data-tab="item">
                                    <div class="comment-item">
                                        <div class="user-info">
                                            <img src="<%=basePath%>resources/upload/portrait/${item.pic}" width="25"
                                                 height="25"
                                                 alt="JY-林佳玮" class="avatar"/> ${item.userName}
                                        </div>
