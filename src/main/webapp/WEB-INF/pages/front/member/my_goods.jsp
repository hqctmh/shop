            ...
            layui.use('laypage', function(){
                ...
                laypage.render({
                    ...
                    ,jump: function(obj, first){
                        ...
                        if(!first){
                            $("#goodsTable").empty();
                            $.post("<%=basePath%>/Goods/findMyGoodsForPage",{pageNum:obj.curr},function (data) {
                                ...
                                for(var x=0;x<data.length;x++){
                                    ...
                                    $("#goodsTable").append("<tr>\n" +
                                        ...
                                        "                <td class=\"operation\">\n" +
                                        "                    <a id='updatePrice-"+id+"'>修改价格</a>\n" +
                                        "                    <a id='updateCount-"+id+"'>进货</a>\n" +
                                        "                    <a id='delGoods-"+id+"'>删除商品</a>\n" +
                                        "                </td>\n" +
                                        "            </tr>")
                                }
                                bind();
